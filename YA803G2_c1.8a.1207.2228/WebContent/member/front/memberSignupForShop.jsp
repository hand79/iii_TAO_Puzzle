...
function shopMagic(){
	...
	document.getElementById("FNAME").value = "店家";
	document.getElementById("IDNUM").value = "12345678";
	document.getElementById("ADDR").value = "中正路300號";
	document.getElementById("TEL").value = "0988133364";
	document.getElementById("EMAIL").value = "77ruru@gmail.com";
		...
		<div class="container">
			<div class="row">
				...
				<div class="login-form">
					<h2 style="font-size: 2.5em; font-family: 微軟正黑體;" class="text-center title">商店會員註冊</h2>
					...
					<form class="form-horizontal" role="form" METHOD="post" ACTION="<%=request.getContextPath()%>/memberC" name="form1" enctype="multipart/form-data" onsubmit="return tickCheck()">
					  ...
					  <div class="form-group ">
					   ...
					   <div class="form-group">
						  <label for="IDNUM" class="col-sm-3 control-label"><i class="fa fa-check-square"></i> 統一編號:</label>
						  <div class="col-sm-6">
...
<!-- 						  <div class="col-sm-2">
					   ...
					   <input type="hidden" name="action" value="insert_by_shop">
					</form>
