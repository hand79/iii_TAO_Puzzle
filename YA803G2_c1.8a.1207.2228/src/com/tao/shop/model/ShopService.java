...
public class ShopService {
	...
	public void update_statusShop(
			Integer status,Integer shopno) {
		dao.update_status(status,shopno);
	}
	...
	public List<ShopVO> getWaitApproveShop() {
		return dao.getWaitApproveShop();
	}
	public ShopVO getCheckStatus(Integer shopno) {
		return dao.checkStatus(shopno);
	}
}
