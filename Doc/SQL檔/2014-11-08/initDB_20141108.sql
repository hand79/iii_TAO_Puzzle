...
CREATE TABLE WTDREQ (
 ...
 WTDREQT               DATE NOT NULL,
 MEMNO                 NUMBER,
 WTDAMNT               NUMBER NOT NULL,
 WTDAC                 NUMBER NOT NULL,
...
SHOP_DESC     VARCHAR2	(4000) NOT NULL	,
PIC		      BLOB						,
MIME          VARCHAR2  (20)			,
LOCNO		  NUMBER	   NOT NULL ,
...
CREATE TABLE CaseProduct (
  ...
  PMIME2 VARCHAR2(20),
  PMIME3 VARCHAR2(20),
  CPDESC VARCHAR2(4000) NOT NULL,
  SUBCATNO NUMBER REFERENCES SubCategory(SUBCATNO) NOT NULL
);
