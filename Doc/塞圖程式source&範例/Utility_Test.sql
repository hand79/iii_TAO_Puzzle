...
insert into test (num, name) values(1, 'Peter' );
insert into test (num, name) values(2, 'Susan' );
insert into test (num, name) values(5, 'John' );
insert into test (num, name) values(6, 'Tom' );
