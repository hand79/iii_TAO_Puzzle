...
public class jdbcUtil_ComQuery_ShopRep {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("srepno".equals(columnName) || "repno".equals(columnName) || "shopno".equals(columnName)) // 用於其他
			aCondition = columnName + "=" + value;
		else if ("sreprsn".equals(columnName) || "sreprsn".equals(columnName)) // 用於varchar
