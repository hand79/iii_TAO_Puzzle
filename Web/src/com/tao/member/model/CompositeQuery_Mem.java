...
public class CompositeQuery_Mem {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("type".equals(columnName) || "status".equals(columnName) || "memno".equals(columnName) || "locno".equals(columnName)) {  // 用於其他
			aCondition = columnName + "=" + value;
		} else if ("memid".equals(columnName) || "email".equals(columnName)) { // 用於varchar
