...
<%
	...
	String Subject      = "帳號已經啟用";
		String messageText  = "謝謝您的註冊。  請點擊如下連結已啟用您的帳號: http://"+ServerName+ ":8081" + ContextPath+"/memberC?action=member_activate&memno="+user_memno+"&status=1"; 
